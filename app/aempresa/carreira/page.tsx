...
export default function PaginaCarreiras() {
  return (
    ...
    <div className="text-center mb-4">
      <h1 className="text-xl lg:text-4xl text-gray-500 font-bold">Trabalhar com propósito</h1>
    </div>
    <div className="flex flex-col w-full items-center mb-4">
      <div className="w-full text-center lg:w-1/2 mb-4">
        <p className="mb-2 text-base text-justify lg:text-center lg:text-lg">Junte-se a nós para construir um novo futuro financeiro em África.</p>
        <p className="mb-2 text-justify lg:text-center">Estamos à procura de estrelas em ascensão que queiram fazer a diferença
        e que ambicionam crescer profissionalmente.</p>
      </div>
    </div>
    <div className="text-center mt-4 mb-4">
      <h2 className="text-xl lg:text-4xl text-gray-500 font-bold mb-4">Porquê escolher-nos</h2>
    </div>
    <div className="flex flex-wrap w-full justify-center ">
      <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-4 lg:gap-2 gap-6">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-justify lg:text-center">Oferecemos á oportunidade de uma carreira profissional promissora numa área inovadora como as fintechs.</p>
        </div>
      </div>
      <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-4 lg:gap-2 gap-6">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-justify lg:text-center">Dinâmicos e objectivos com resposta rápida.</p>
        </div>
      </div>
      <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-4 lg:gap-2 gap-6">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-justify lg:text-center">Junte-se a nós para moldar o futuro das Fintechs.</p>
        </div>
      </div>
      <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-4">
        <div className="flex flex-col items-center lg:gap-2 gap-6">
          ...
          <p className="text-sm text-justify lg:text-center">O desenvolvimento de sistemas seguros e benéficos requer pessoas intelectualmente capazes.</p>
        </div>
      </div>
    </div>
  </div>
