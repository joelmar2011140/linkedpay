    ...
    <FadeRight>
      <div className=' w-full h-full p-4 flex flex-col items-center justify-center lg:justify-around'>
        <div className="mx-auto flex items-center w-full lg:w-[83%] justify-center flex-col lg:flex-row gap-8 p-4">
          <div className="w-full gap-12 h-full lg:w-[50%] lg:h-[580px] p-4 text-center lg:text-justify lg:p-16 font-semibold border rounded-lg items-center justify-center lg:items-start lg:justify-start">
            <h1 className="text-xl mb-12 lg:text-2xl  text-center">Levantamentos LPay</h1>
          ...
          <div className="w-full gap-12 h-full lg:w-[50%] lg:h-[580px] p-4 text-center lg:text-justify lg:p-16 font-semibold border rounded-lg items-center justify-center lg:items-start lg:justify-start">
            <h1 className="text-xl mb-12 lg:text-2xl text-center">Suporte personalizado</h1>
