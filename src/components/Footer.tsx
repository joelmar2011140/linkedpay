...
export default function Footer() {
  return (
    <div className="w-screen h-full bg-violet-900 p-2 flex flex-col justify-center items-center gap-6">
      <DownloadApp />
      {/* linha */}
      <div className="w-full lg:w-[70%] divide-y divide-white-600">
        <div></div>
        <div></div>
      </div>
      <div className="mx-auto flex flex-col p-4 w-full lg:w-[83%]">
        <div className="mx-auto p-4  content-center w-full lg:w-[95%] gap-6 grid grid-cols-1 lg:grid-cols-5">
          <div className="w-full text-center lg:text-justify text-[#f3f4fe] p-4 flex flex-col gap-4 items-center justify-start">
              <div className="max-w-[100px]  mx-auto lg:mx-0">
                <Image
                  ...
                  className="w-[100%] h-[70%] flex items-center sm:justify-center"
                />
              </div>
              ...
              <div className="flex -mx-3">
                ...
                <Link
                  href='https://twitter.com/Linkedpay' target='_blank'
                  className="px-3 text-[#dddddd] hover:text-white"
                >
                  <svg
                    width="25"
                ...
                <Link
                  href='https://www.instagram.com/linkedpay' target='_blank'
                  className="px-3 text-[#dddddd] hover:text-white"
                >
                  <svg
                    width="25"
                ...
                <Link
                  href='https://www.linkedin.com/in/linkedpay' target='_blank'
                  className="px-3 text-[#dddddd] hover:text-white"
                >
                  <svg
                    width="25"
          ...
          <div className="w-full text-center lg:text-justify text-[#f3f4fe] p-4 flex flex-col gap-2 items-start justify-start">
             <h1 className="text-white text-base lg:text-xl">Agentes</h1>
             <Link href='/agentes' className="text-white font-semibold">Informações</Link>
          </div>

          <div className="w-full text-center lg:text-justify text-[#f3f4fe] p-4 flex flex-col gap-2 items-start justify-start">
             <h1 className="text-white text-base lg:text-xl">Empresa</h1>
             <Link href='/aempresa/sobrenos' className="text-white font-semibold">Sobre Nós</Link>
             <Link href='/aempresa/carreira' className="text-white font-semibold">Carreiras</Link>
             <Link href='/aempresa/blog' className="text-white font-semibold">Blog</Link>
          </div>
          <div className="w-full text-center lg:text-justify text-[#f3f4fe] p-4 flex flex-col gap-2 items-start justify-start">
             <h1 className="text-white text-base lg:text-xl">Ajuda</h1>
             <a href='malito:info@linkedpay.co.ao' className="text-white font-semibold">Entrar em contacto</a>
             <Link href='/faqs' className="text-white font-semibold">Perguntas frequentes</Link>
             
          </div>
          <div className="w-full text-center lg:text-justify text-[#f3f4fe] p-4 flex flex-col gap-2 items-start justify-start">
             <h1 className="text-white text-base lg:text-xl">Legal</h1>
             <Link href='/politica' className="text-white text-left font-semibold">Políticas de Cookies e privacidade</Link>
             <Link href='/termos' className="text-white text-left font-semibold">Termos e condições</Link>
          </div>
        </div>
      </div>
    </div>
