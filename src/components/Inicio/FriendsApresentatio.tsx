  ...
  return (
    ...
    <div className=' w-full h-full p-4 flex flex-col items-center justify-center lg:justify-around'>
      <div className="mx-auto flex items-center w-full lg:w-[83%] justify-center flex-col lg:flex-row gap-16 lg:gap-8 p-4">
        <div className="w-full gap-12 h-full lg:w-[50%] lg:h-[1024px] p-4 text-center lg:text-justify lg:p-16  bg-gray-100 rounded-lg items-center justify-center lg:items-start lg:justify-start">
          <h1 className="font-semibold text-xl mb-12 lg:text-2xl lg:text-start text-center">A LinkedPay está integrada no ecossistema de pagamentos bancários nacional</h1>
        ...
        <div className=" bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 w-full gap-8 lg:gap-4 text-white lg:h-[560px] h-full lg:w-[50%] p-4 text-center lg:text-justify lg:p-16  bg-gray-100 rounded-lg items-center justify-center lg:items-start lg:justify-start">
          <h1 className="text-xl mb-12 font-semibold lg:text-2xl lg:text-start text-center">Apresente aos seus amigos e seja pago</h1>
